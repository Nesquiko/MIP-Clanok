...
Informatiku nám priniesla vojna, počas ktorej skupina okolo Alana Turinga zkonštruovala prvý stroj, ktorý sa dal nazvať
počítačom. Odvtedy sa tento obor rozrástol do enormných rozmerov. Na prednáškach nám boli spomenutí významní ľudia, ktorí
posunuli tento svet núl a jednotiek veľkým krokom vpred. Napríklad:

\begin{itemize}
	\item Frances Allen - zaoberala sa prvými kompilátormi a ich optimilizáciou
	\item Fernando Corbato - vďačíme nemu môžu viacerí uživatelia používať jeden počítač - time sharing
	\item Larry Tesler - jedna z najpoužívanejších funkcií na počítači, copy and paste
\end{itemize}
