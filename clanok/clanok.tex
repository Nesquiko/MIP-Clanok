...
\subsection{Typy}\label{implementacia:formy}
...
Samozrejme dôležitá je prax, to ako uživateľ používa a vníma daný nástroj.

% TODO Using... statistiky ako, kedy, preco z poznamok

Najdôležitejšie je pre developera minimalizovanie pozastavenia pracovného priebehu. Väčšinou vývojar nezaraďuje
čas na vykonanie analýzy do svojho pracovného priebehu, lebo len čaká na výsledok. Behom tohto času vývojar stráca
sústredenie na daný problém a pre toto klesá motivácia developera používať daný nástroj.
